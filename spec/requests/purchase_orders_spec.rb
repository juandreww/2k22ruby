  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new PurchaseOrder" do
        expect {
          post purchase_orders_url, params: { purchase_order: valid_attributes }
        }.to change(PurchaseOrder, :count).by(1)
      end

      it "redirects to the created purchase_order" do
        post purchase_orders_url, params: { purchase_order: valid_attributes }
        expect(response).to redirect_to(purchase_order_url(PurchaseOrder.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new PurchaseOrder" do
        expect {
          post purchase_orders_url, params: { purchase_order: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested purchase_order" do
        purchase_order = PurchaseOrder.create! valid_attributes
        patch purchase_order_url(purchase_order), params: { purchase_order: new_attributes }
      ...
      it "redirects to the purchase_order" do
        ...
        patch purchase_order_url(purchase_order), params: { purchase_order: new_attributes }
        purchase_order.reload
        expect(response).to redirect_to(purchase_order_url(purchase_order))
      end
    end
    ...
    context "with invalid parameters" do
      it "renders a successful response (i.e. to display the 'edit' template)" do
        purchase_order = PurchaseOrder.create! valid_attributes
        patch purchase_order_url(purchase_order), params: { purchase_order: invalid_attributes }
        expect(response).to be_successful
      end
    end
  end
